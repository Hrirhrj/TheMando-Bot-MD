	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363327911341310@newsletter',
            newsletterName: '𝑺𝑶𝑵𝑬𝑲⚡𝑴𝑨𝑵𝑫𝑶', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363327911341310@newsletter", "120363327911341310@newsletter", "120363327911341310@newsletter", "120363327911341310@newsletter", "120363334163906836@newsletter"]
let canalNombre = ["𝑺𝑶𝑵𝑬𝑲⚡𝑴𝑨𝑵𝑫𝑶", "𝑺𝑶𝑵𝑬𝑲⚡𝑴𝑨𝑵𝑫𝑶", "𝑺𝑶𝑵𝑬𝑲⚡𝑴𝑨𝑵𝑫𝑶", "𝑺𝑶𝑵𝑬𝑲⚡𝑴𝑨𝑵𝑫𝑶", "𝑺𝑶𝑵𝑬𝑲⚡𝑴𝑨𝑵𝑫𝑶"]
